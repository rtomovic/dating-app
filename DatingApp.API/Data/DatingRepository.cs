...
namespace DatingApp.API.Data
{
    public class DatingRepository : IDatingRepository
    {
        ...
        public DatingRepository(DataContext context) => this._context = context;
        ...
        public async Task<Photo> GetMainPhotoForUser(int userId) => await _context.Photos.Where(u => u.UserId == userId)
